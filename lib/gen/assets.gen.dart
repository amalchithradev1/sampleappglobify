...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/noproduct.png
  AssetGenImage get noproduct =>
      const AssetGenImage('assets/images/noproduct.png');

  /// List of all assets
  List<AssetGenImage> get values => [car, noproduct];
}
